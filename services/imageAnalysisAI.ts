...
/**
 * Advanced Image Analysis AI Service with admin capabilities
 * Handles customer image analysis using OpenRouter's AI models with admin access
 */
export const imageAnalysisAI = {
  ...
  FREE_MODELS: [
    ...
    "microsoft/phi-3.5-vision-instruct:free", // Vision capabilities
